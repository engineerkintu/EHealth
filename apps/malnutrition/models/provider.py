...
class Provider(models.Model):
    ...
    following_users = models.ManyToManyField("Provider", related_name="following_users2", blank=True, null=True)
    following_clinics = models.ManyToManyField("Facility", related_name="following_clinics2", blank=True, null=True)
