...
from apps.malnutrition.utils.data import stunting_boys, stunting_girls
from apps.malnutrition.utils.data import weight_for_height as weight_for_height_data
