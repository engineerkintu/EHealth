...
# and README.rst, a rst directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'mHospital')
...
SECRET_KEY = 'prqy95ui(e17bwphhrl+un@p!t07u_^=s#m4ki0k11*rpmnf6)'
...
ROOT_URLCONF = 'apps.webui.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wsgi.application'

TEMPLATE_DIRS = (
    os.path.join(PROJECT_PATH, 'apps.webui.templates'),
)
...
RAPIDSMS_HANDLERS = (
   ...
   # "tut.myhandlers.ResultsHandler",
  # "tut.myhandlers.VoteHandler",

    
  #  "rst.myhandlers.VoteHandler",
